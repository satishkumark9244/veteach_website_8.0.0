...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'header.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/header.html'`` the file from the app1 package is loaded,
    by loading ``'app2/header.html'`` the file from the second.
    """
